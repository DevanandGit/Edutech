...
class MultipleChoice(models.Model):
    ...
    option1_text = models.CharField(max_length=100, blank=True,null=True)
    option2_text = models.CharField(max_length=100, blank=True,null=True)
    option3_text = models.CharField(max_length=100, blank=True,null=True)
    option4_text = models.CharField(max_length=100, blank=True,null=True)
...
class Options(models.Model):
    ...
    options_text = models.CharField(max_length=100, blank=True, null=True)
